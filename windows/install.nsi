...
Section "MainSection" SEC01
  ...
  File "..\dist\recordium\media\icon-recordium-192.png"
  File "..\dist\recordium\media\icon-recordium-active-192.png"
  File "..\dist\recordium\media\icon-recordium-problem-192.png"
...
Section Uninstall
  ...
  Delete "$INSTDIR\media\icon-recordium-problem-192.png"
  Delete "$INSTDIR\media\icon-recordium-active-192.png"
  Delete "$INSTDIR\media\icon-recordium-192.png"
